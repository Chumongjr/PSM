...
<section class="content">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"> Station Lists </h1>
                </div><!-- /.col -->
                <div class="col-sm-6" align="right">
                    <?= Html::button('<i class="fa fa-plus"></i> Add Station', ['value'=>Url::to(['/stations/create']),'title'=>'Create New Station','class'=>'showModalButton btn bg-olive']) ?>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    <?php if (Yii::$app->session->hasFlash('statreg_success')): ?>
        <div class="alert alert-success alert-dismissable">
            <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
            <?= Yii::$app->session->getFlash('statreg_success')?>
        </div>
    <?php endif; ?>
