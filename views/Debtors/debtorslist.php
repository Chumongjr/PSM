...
<section class="content">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"> Debtors Lists </h1>
                </div><!-- /.col -->
                <div class="col-sm-6" align="right">
                    <?= Html::button('<i class="fa fa-plus-square"></i> Add Debtor', ['value'=>Url::to(['/debtors/create']),'title'=>'Create New Debtor','class'=>'showModalButton btn bg-olive']) ?>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <?php endif; ?>
    <?php if (Yii::$app->session->hasFlash('scomplete_sucess')): ?>
        <div class="alert alert-success alert-dismissable">
            <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
            <?= Yii::$app->session->getFlash('scomplete_sucess')?>
        </div>
    <?php endif; ?>
