...
<section class="content">
    ...
    <?php if (Yii::$app->session->hasFlash('success-crmethod')): ?>
        <div class="alert alert-success alert-dismissable">
            <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
            <?= Yii::$app->session->getFlash('success-crmethod')?>
        </div>
    <?php endif; ?>
    <?php if (Yii::$app->session->hasFlash('success-rmpay')): ?>
        <div class="alert alert-success alert-dismissable">
            <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
            <?= Yii::$app->session->getFlash('success-rmpay')?>
        </div>
    <?php endif; ?>
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    <?= $form->field($model, 'payment_method')->textInput(['placeholder'=>'Enter Payment Method'])->label(true) ?>
                                </div>
                                <div class = "form-group" align="center">
                                    <?= Html::submitButton('Add', ['class'=> 'btn bg-olive','name'=>'btnpmethod' ]); ?>
                                </div>
